...
| 21.Set a 24.Set  | [Ficha 1 (Especificações)](./pdfs/ficha1tp.pdf)          | Validade de um Triplo de Hoare. Regras de prova: Sequência, atribuição e condicionais |
| 28.Set a 2.Out   |  [Ficha 1 (Correcção)](./pdfs/ficha1tp.pdf)                  | Correcção de ciclos: variantes e invariantes.                      |
| 05.Out a 09.Out   |  [Ficha 1 ((In)variantes)](./pdfs/ficha1tp.pdf)               | Introdução à análise de complexidade. Tamanho do input. Melhor e pior casos. Caso médio. |
...
# Contactos 
  ...
  | [Jorge Sousa Pinto](mailto:jsp@di.uminho.pt)     | 4a-f, 9h00-11h00 (enviar e-mail antes) |
